  ...
  return (
    ...
    <div className='containermovie bg-black '>
      ...
      <Carousel interval={2000} prevIcon={<GrPrevious />} nextIcon={<GrNext />}>
        ...
        <Carousel.Item>
          <a href='/Details/1311031'> <div className='imgcarrossel' style={{
            height: "27vw", width: "100%", backgroundPosition: "center",
            backgroundRepeat: "no-repeat", backgroundPositionY: "44%", backgroundSize: "cover", backgroundImage: `url(${nine})`
          }}> </div></a>
        ...
        <Carousel.Item>
          <a href='/Details/1278950'> <div className='imgcarrossel' style={{
            height: "27vw", width: "100%", backgroundPositionY: "80%",
            backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundImage: `url(${eight})`
          }}> </div></a>
          <Carousel.Caption >
        ...
        <Carousel.Item>
          <a href='/Details/1126166'> <div className='imgcarrossel' style={{
            height: "27vw", width: "100%", backgroundPosition: "center", backgroundPositionY: "45%",
            backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundImage: `url(${seven})`
          }}> </div></a>
          <Carousel.Caption>
