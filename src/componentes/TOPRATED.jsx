  ...
  return (
    <div className='containermovie  bg-black'>
      ...
      <Carousel interval={2000} prevIcon={<GrPrevious />} nextIcon={<GrNext />}>
        ...
        <Carousel.Item>
          <a href='/Details/803796'> <div className='imgcarrossel' style={{
            height: "27vw", width: "100%", backgroundPosition: "center",
            backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundImage: `url(${five})`
          }}> </div></a>
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <a href='/Details/155'><div className='imgcarrossel' style={{
            height: "27vw", width: "100%", backgroundPosition: "center",
            backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundImage: `url(${six})`
          }}> </div> </a>
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <a href='/Details/429'> <div className='imgcarrossel' style={{
            height: "27vw", width: "100%", backgroundPositionY: "22.5%",
            backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundImage: `url(${four})`
          }}> </div> </a>
          <Carousel.Caption>
          ...
          return (
            <div key={movie.id} className=" col-6 col-sm-4 col-md-4 col-lg-4 col-xl-3 col-xxl-2 ">
              ...
              <div style={{ backgroundColor: "rgb(0, 0, 0)" }} className="card img-fluid justify-content-center text-center anime">
                <img style={{ cursor: "pointer" }} onClick={() => handleGoToDetails(movie.id)} src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} className="movie divimg card-img-top img-fluid" alt="" />
